...
- [Kubernetes — Helm pre-upgrade hooks](../Infrastructure/kubernetes.md)
- [Docker — миграции в контейнере](../Infrastructure/docker.md)
- [PostgreSQL Deep — Advisory Locks](../SQL/postgresql-deep.md)
- [SQL Optimization — индексы](../SQL/optimization.md)
- [Distributed Systems — Outbox через миграции](../Architecture/distributed-systems.md)
