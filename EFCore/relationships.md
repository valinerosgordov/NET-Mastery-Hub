...
См. [PostgreSQL Deep — Recursive CTE](../SQL/postgresql-deep.md).
...
См. [PostgreSQL Deep — JSONB](../SQL/postgresql-deep.md).
...
См. [SQL Optimization — индексы](../SQL/optimization.md).
...
- [EF Core Patterns](patterns.md) — Repository, soft delete, audit interceptors
- [DDD на практике](../Architecture/ddd.md) — Aggregate roots, Value Objects
- [PostgreSQL Deep — JSONB](../SQL/postgresql-deep.md)
- [SQL Optimization — индексы](../SQL/optimization.md)
