...
См. [[../CSharp/source-generators|Source Generators]] и [[native-aot|Native AOT]].
...
См. [[../CSharp/source-generators|Source Generators]].
...
- [[../CSharp/source-generators|Source Generators]] — Mapperly использует SG
- [[../EFCore/queries-performance|EF Queries Performance]] — ProjectTo
- [[../Architecture/cqrs-mediatr|CQRS & MediatR]] — где mapping применяется
- [[../Architecture/ddd|DDD]] — Domain vs DTO separation
