...
См. [PostgreSQL Deep](../SQL/postgresql-deep.md) — Row-Level Security как **нижний** слой защиты в многотенантной системе.
...
- [PostgreSQL Deep](../SQL/postgresql-deep.md) — RLS как defense-in-depth для multi-tenant
- [Distributed Systems](../Architecture/distributed-systems.md) — propagation auth context между сервисами через OpenTelemetry baggage
