...
Если плагины критичны — выноси их в **отдельные процессы** (см. [IPC patterns](../Infrastructure/ipc-named-pipes-grpc.md)).
...
См. [Source Generators](../CSharp/source-generators.md) — AOT и SG взаимосвязаны, без SG большинство фреймворков сломается.
...
- [Source Generators](../CSharp/source-generators.md) — фундамент AOT (без них большинство frameworks ломается)
- [Compilation и JIT](../Runtime/compilation-jit.md) — как работает обычная JIT-компиляция
- [Modern C# 8–14](../CSharp/modern-features.md) — primary constructors, collection expressions (всё AOT-friendly)
- [Project Setup](project-setup.md) — современная структура с AOT-готовностью
- [Docker](docker.md) — distroless containers + AOT
