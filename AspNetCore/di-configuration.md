...
См. [Native AOT](native-aot.md) и [Source Generators](../CSharp/source-generators.md).
...
См. [HFT/Low-Latency](../Performance/hft-low-latency.md) — почему `GetAwaiter().GetResult()` в Dispose — антипаттерн.
...
- [Source Generators](../CSharp/source-generators.md) — Configuration Binding Source Generator
