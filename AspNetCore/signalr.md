...
См. [Diagnostics Tools](../Runtime/diagnostics-tools.md).
...
- [Distributed Systems](../Architecture/distributed-systems.md) — pub/sub, MQ
- [IPC: Named Pipes & gRPC](../Infrastructure/ipc-named-pipes-grpc.md) — alternatives
- [Caching](caching.md) — Redis для backplane
- [Diagnostics Tools](../Runtime/diagnostics-tools.md) — мониторинг
