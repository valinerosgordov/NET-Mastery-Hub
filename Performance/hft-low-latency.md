...
- [Span, Memory, Layout](../Runtime/span-layout.md) — глубже про Span/Memory/StructLayout
- [Concurrency и Atomics](../Runtime/concurrency-atomics.md) — Volatile, CAS, memory barriers
- [GC, LOH и POH](../Runtime/gc-memory.md) — поколения, фрагментация, finalization
- [Async и Threading](../CSharp/async-threading.md) — async overhead, ConfigureAwait, Channel
- [IPC](../Infrastructure/ipc-named-pipes-grpc.md) — MMF ring-buffer для market data feed
- [Performance](../Performance/performance.md) — BenchmarkDotNet, profiling
- [WPF Production](../Infrastructure/wpf-production.md) — UI thread vs hot-path threads
