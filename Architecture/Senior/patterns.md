...
> Определить bounded contexts (DDD). Выделить модули по бизнес-доменам. Strangler Fig pattern — постепенная замена. Не начинать с микросервисов — Modular Monolith как промежуточный шаг.
