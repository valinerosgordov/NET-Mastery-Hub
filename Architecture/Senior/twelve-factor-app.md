...
См. [[dotnet-cli-getting-started|.NET CLI]] и [[project-setup|Project Setup]].
...
См. [[nosql-databases|NoSQL Databases]] (Redis sessions).
...
См. [[kubernetes|Kubernetes]] и [[hosting-background|Hosting Background]].
...
См. [[kubernetes|Kubernetes lifecycle]] и [[http-fundamentals|Idempotency]].
...
См. [[logging-observability|Logging & Observability]] и [[observability|Observability]].
...
См. [[kubernetes|Kubernetes]] и [[cicd-github-actions|CI/CD]].
...
См. [[nosql-databases|Redis для sessions]].
...
См. [[hosting-background|Hosting Background]] и [[kubernetes|Kubernetes lifecycle]].
...
См. [[kubernetes|Kubernetes]], [[observability|Observability]], [[cicd-github-actions|CI/CD]].
...
- [[kubernetes|Kubernetes]] — runtime для 12-factor apps
- [[docker|Docker]] — packaging
- [[cicd-github-actions|CI/CD]] — build/release/run
- [[observability|Observability]] — logs as streams
- [[nosql-databases|NoSQL]] — Redis for stateless
