...
См. подробно в [API Design](../AspNetCore/api-design.md) — `IEndpoint` pattern.
...
См. [Resilience](../AspNetCore/resilience.md) — Polly v8 deep.
...
**Решение:** правильно обрабатывать ошибки в каждом handler, или использовать **distributed events через message bus** (см. [Messaging](../Infrastructure/messaging.md)).
...
- [Architecture Patterns](patterns.md) — Clean, VSA, modular monolith
...
- [Result Pattern](../Snippets/result-pattern.md) — return values handlers
- [Caching](../AspNetCore/caching.md) — caching pipeline behavior
- [Resilience](../AspNetCore/resilience.md) — retry pipeline behavior
- [Testing](../Testing/testing.md) — тесты handlers с моками
