...
- [ООП и классы](../CSharp/oop.md) — Наследование, интерфейсы, полиморфизм
- [DI и Configuration](../AspNetCore/di-configuration.md) — Dependency Injection в .NET
- [DDD на практике](ddd.md) — SOLID в контексте Domain-Driven Design
- [Architecture Patterns](patterns.md) — Clean Architecture (применение DIP)
