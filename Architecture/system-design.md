...
См. подробнее в [LLM/RAG patterns](../Infrastructure/llm-rag-patterns.md). Ключ — fusion top-K через RRF (Reciprocal Rank Fusion).
...
- [PostgreSQL Deep](../SQL/postgresql-deep.md) — RLS, JSONB, partitioning
- [LLM / RAG patterns](../Infrastructure/llm-rag-patterns.md) — search, embeddings, hybrid
- [Caching](../AspNetCore/caching.md) — IMemoryCache, IDistributedCache
- [Resilience](../AspNetCore/resilience.md) — retry, circuit breaker, timeout
- [Observability](../Infrastructure/observability.md) — OpenTelemetry, metrics, traces
