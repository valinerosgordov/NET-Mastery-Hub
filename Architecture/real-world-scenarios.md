...
См. [[../Performance/performance|Performance]] и [[../EFCore/queries-performance|EF Queries Performance]].
...
См. [[../CSharp/design-patterns#State|State Pattern]].
...
См. [[../Infrastructure/messaging|Messaging]].
...
См. [[ddd|DDD]] и [[../EFCore/patterns|EF Patterns]].
...
См. [[../CSharp/io-streams|I/O & Streams]] и [[../CSharp/iterators-yield|Iterators & yield]].
...
См. [[patterns|Architecture Patterns]] и [[ddd|DDD]].
...
См. [[../SQL/postgresql-deep|PostgreSQL Deep]] (Row-Level Security).
...
См. [[../Performance/hft|HFT Performance]] и [[../CSharp/types-and-memory|Types & Memory]].
...
| Multi-step wizard | State pattern (records) | [[../CSharp/design-patterns]] |
| Notifications через email/SMS/push | Strategy + Mediator | [[../Infrastructure/messaging]] |
| Undo/redo в UI | Command pattern | [[../CSharp/design-patterns]] |
| Корзина e-commerce | Aggregate (DDD) + Redis | [[ddd]] + [[../EFCore/patterns]] |
| Биллинг / подписки | State machine + Saga | [[distributed-systems]] |
| Поиск товаров | CQRS + Elasticsearch | [[cqrs-mediatr]] |
| Reporting / аналитика | Dapper + read replica | [[../EFCore/dapper-comparison]] |
| Import CSV millions rows | Streaming + batching | [[../CSharp/io-streams]] |
...
- [[patterns|Architecture Patterns]] — N-Layer / Clean / VSA
