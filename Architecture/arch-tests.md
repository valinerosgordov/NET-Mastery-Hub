...
См. подробно [Source Generators](../CSharp/source-generators.md) — Roslyn API similar к analyzers.
...
- [Architecture Patterns](patterns.md) — Clean / Hexagonal / VSA — что проверяешь
...
- [Code Quality](../Quality/code-quality.md) — analyzers, EditorConfig, SonarCloud
- [Architecture Decisions](architecture-decisions.md) — ADR formats
- [Testing](../Testing/testing.md) — общие подходы к тестированию
