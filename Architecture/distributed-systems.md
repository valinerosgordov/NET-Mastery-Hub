...
- [CQRS и MediatR](../Architecture/cqrs-mediatr.md) — Command/Query разделение
- [DDD на практике](../Architecture/ddd.md) — domain events, aggregates как boundary
- [Messaging](messaging.md) — RabbitMQ, MassTransit основы
- [Resilience и HttpClient](../AspNetCore/resilience.md) — Polly v8, circuit breaker, retry
- [PostgreSQL Deep](../SQL/postgresql-deep.md) — advisory locks, row-version, transactions
- [Logging и Observability](../AspNetCore/logging-observability.md) — OpenTelemetry для distributed tracing
