...
См. подробно в [System Design](../Architecture/system-design.md) — capacity estimation.

---

## Architecture tests — NetArchTest

См. подробно в [arch-tests.md](../Architecture/arch-tests.md). Кратко — проверка архитектурных правил кодом.
...
- [Architecture Tests](../Architecture/arch-tests.md) — NetArchTest для архитектурных правил
- [Performance](../Performance/performance.md) — BenchmarkDotNet, NBomber, profiling
- [Distributed Systems](../Architecture/distributed-systems.md) — testing distributed flows, saga
- [Blazor Server](../AspNetCore/blazor-server.md) — bUnit для component testing
- [Auth и Security](../AspNetCore/auth-security.md) — TestAuthHandler для integration tests
- [Source Generators](../CSharp/source-generators.md) — Verify для snapshot-тестирования генератора
