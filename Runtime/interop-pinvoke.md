...
См. [GC и память — SafeHandle](gc-memory.md).
...
См. [GC — GCHandle типы](gc-memory.md).
...
См. [HFT/Low-Latency](../Performance/hft-low-latency.md) — паттерн STA-thread + COM для MT5 интеграции в .NET trading bot.
...
См. [IPC: Named Pipes & gRPC](../Infrastructure/ipc-named-pipes-grpc.md) — MMF для high-perf IPC.
...
См. [HFT/Low-Latency](../Performance/hft-low-latency.md) — полный паттерн STA-thread + COM для MT5 trading bot.

---

## См. также

- [Compilation/JIT](compilation-jit.md) — как P/Invoke stubs работают
- [GC и память](gc-memory.md) — Pinning, SafeHandle, GCHandle
- [Span и Memory Layout](span-layout.md) — Span в interop, MemoryMarshal
- [Concurrency и Atomics](concurrency-atomics.md) — multithreading с native
- [HFT/Low-Latency](../Performance/hft-low-latency.md) — MT5 COM, реальный case
- [IPC: Named Pipes & gRPC](../Infrastructure/ipc-named-pipes-grpc.md) — MMF для shared memory
- [Native AOT](../AspNetCore/native-aot.md) — limitations interop в AOT
