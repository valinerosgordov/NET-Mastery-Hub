...
См. [[concurrency|EF Core concurrency]] — детали isolation levels.
...
См. [[distributed-systems|Distributed Systems]] — CQRS read models часто денормализованы.
...
- [[basics-tracking|EF Core Basics]] — как EF translates LINQ to SQL
- [[queries-performance|EF Queries Performance]] — N+1, projection
- [[concurrency|EF Concurrency]] — isolation levels, locking
