...
- [EF Core Queries и Performance](../EFCore/queries-performance.md) — N+1, проекции, compiled queries
- [EF Core Concurrency](../EFCore/concurrency.md) — optimistic concurrency, transactions, retry
- [LLM / RAG patterns](../Infrastructure/llm-rag-patterns.md) — pgvector в реальной RAG-системе
- [Semantic Kernel](../Infrastructure/semantic-kernel.md) — pgvector через Microsoft.Extensions.AI
