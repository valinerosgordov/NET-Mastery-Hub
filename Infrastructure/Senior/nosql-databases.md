...
См. [[dapper-comparison|Dapper vs EF]] — для SQL контекста.
...
См. [[caching|Caching]] и [[auth-security|Auth & Security]].
...
- [[dapper-comparison|Dapper vs EF Core]] — для SQL контекста
- [[basics-tracking|EF Core Basics]]
- [[postgresql-deep|PostgreSQL Deep]] — JSONB как NoSQL alternative
