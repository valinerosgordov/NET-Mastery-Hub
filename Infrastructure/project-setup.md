...
См. [Kubernetes — Secrets](../Infrastructure/kubernetes.md).
...
- [Code Quality](../Quality/code-quality.md) — analyzers deep
- [Docker](docker.md) — Dockerfile best practices
- [Kubernetes](kubernetes.md) — k8s deployment
- [Architecture Decisions](../Architecture/architecture-decisions.md) — ADR process
