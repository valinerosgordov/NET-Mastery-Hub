...
См. [[patterns-decision-guide|Patterns Decision Guide]].
...
См. [[testing|Testing]] и [[mocking-strategies|Mocking Strategies]].
...
- [[patterns-decision-guide|Patterns Decision Guide]] — что AI делает плохо
- [[code-review|Code Review]] — review AI-generated code
- [[security-practices|Security Practices]] — protect от prompt injection
