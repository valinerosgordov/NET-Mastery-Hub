...
- [Semantic Kernel и Vector Search](../Infrastructure/semantic-kernel.md) — введение в SK, vector store comparison, pgvector
- [Resilience и HttpClient](../AspNetCore/resilience.md) — Polly v8, retry/timeout/circuit breaker для LLM-вызовов
- [PostgreSQL Deep](../SQL/postgresql-deep.md) — pgvector, JSONB, Row-Level Security для multi-tenant RAG
- [API Design](../AspNetCore/api-design.md) — SSE, Minimal API, Server-Sent Events
- [Testing](../Testing/testing.md) — Testcontainers для интеграционных тестов RAG-пайплайна
