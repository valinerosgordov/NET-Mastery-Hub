...
См. [[../CSharp/error-handling|Error Handling]] для Result\<T,E\> patterns.
...
См. [[../LearningPath/99_reading-list|Reading List]].
...
- [[../CSharp/error-handling|Error Handling]] — паттерны для ошибок
- [[../CSharp/oop|OOP]] — объектно-ориентированные принципы
- [[../Architecture/solid|SOLID]] — высокоуровневые принципы
