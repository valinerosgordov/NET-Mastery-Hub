...
См. [[../Testing/integration-testing|Integration Testing]].
...
См. [[../LearningPath/03_middle-to-senior|Middle → Senior]] — Senior softskill умение приоритизировать debt.
...
- [[../Architecture/solid|SOLID]] — принципы которые помогают rеfactor
- [[../Testing/integration-testing|Integration Testing]] — characterization tests
- [[../CSharp/design-patterns|Design Patterns]] — целевая структура
