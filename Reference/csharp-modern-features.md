# C# — Современные возможности (C# 8–14)

> Полный справочник по фичам языка, появившимся с C# 8 по C# 14.
> Каждая секция содержит рабочие примеры кода.
...
- [[Reference/csharp-types-and-basics|Типы и основы]]
- [[Reference/csharp-oop-classes|OOP и классы]]
- [[Reference/csharp-delegates-events|Делегаты и события]]
- [[Reference/csharp-collections-linq|Коллекции и LINQ]]
- [[Reference/csharp-async-threading|Async и многопоточность]]
